  ...
  return (
    <div className = 'px-4'>
        <Popover className = 'relative'>
            {({ open }) => (
                <>
                    {/* displays user information as a button */}
                    <Popover.Button className = 'group inline-flex items-center outline-none'>
                        <span>
                            {
                                getInitials(user?.name) // obtains user initials
                            }
                        </span>
                    </Popover.Button>

                    {/* transition when user initials are clicked in order to display information */}
                    <Transition
                        as={Fragment}
                    ...
                    >
                        <Popover.Panel className = 'absolute left-1/2 z-10 mt-3 w-80 max-w-sm -translate-x-1/2 transform px-4 sm:px-0'>
                            <div className = 'flex to-current gap-4 rounded-lg shadow-lg bg-white p-4'>
                                ...
                                {/* displays user name, title, email */}
