...
const Trash = () => {
  ...
  // takes specific task and displays in trash
  const TableRow = ({ item }) => (
    <tr className='border-b border-gray-200 text-gray-600 hover:bg-gray-400/10'>
      {/* table data for task name */}
      <td className='py-2'>
      ...
      {/* table data to edit and delete tasks */}
